...
Timer downloadServerUnixTimer = Timer(600000);
...
void loop() {
  if (downloadServerUnixTimer.hasElapsed()) {
    
    Serial.println("downloadServerUnixTimer elapsed.");
    ...
    Serial.println("downloadServerUnixTimer not elapsed.");
  }
